(function ($) {
    ...
    $.fn.extend({
        ...
        helpfullyPlacehold: function () {
            ...
            // because "base.js" conflicts with jQuery.placeholder we decided to force jQueryPlaceholder leave a trace on the window object and not execute base.js/placeholder in that case
            if(window.jQueryPlaceholder) {
                return _this;
            }
